                ...
                <div class="about_us_img">
                    <div class="about_us_img_flex">
                        <div class="about_us_img_flex_left">
                            <?php if(!empty(pagesetting('about_area_img_medium'))): ?>
                                <div class="about_us_img_item">
                                    <div class="about_area_img_medium">
                                        <img src="<?php echo e(pagesetting('about_area_img_medium')[0]['thumbnail']); ?>" alt="">
                                    </div>
                                </div>
                            <?php endif; ?>
                            
                            <?php if(!empty(pagesetting('about_area_img_small'))): ?>
                                <div class="about_us_img_item">
                                    <div class="about_us_img_item_img small-img">
                                        <img src="<?php echo e(pagesetting('about_area_img_small')[0]['thumbnail']); ?>" alt="">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
                        <div class="about_us_img_flex_right">
                            <?php if(!empty(pagesetting('about_area_img_large'))): ?>
                                <div class="about_us_img_item">
                                    <div class="about_us_img_item_img large-img">
                                        <img src="<?php echo e(pagesetting('about_area_img_large')[0]['thumbnail']); ?>" alt="">
                                    </div>
                                </div>
                            <?php endif; ?>
                        </div>
...
<!-- about area end -->
<?php /**PATH D:\php\htdocs\resources\views/themes/edulia/pagebuilder/about-section/view.blade.php ENDPATH**/ ?>