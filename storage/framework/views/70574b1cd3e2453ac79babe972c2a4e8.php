...
<?php if($students->isEmpty() && auth()->check() && auth()->user()->role_id == 1): ?>
    <p class="text-center text-danger mt-4"><?php echo app('translator')->get('edulia.no_data_available_please_go_to'); ?> <a target="_blank"
...
<?php endif; ?>
<?php /**PATH D:\php\htdocs\resources\views/components/edulia/frontend-student-list.blade.php ENDPATH**/ ?>